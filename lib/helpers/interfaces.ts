...
interface IApiRequest {
	...
	url: string;
	contentType?: string;
	data: string | boolean | {[key: string ]: any};
	accept?: string;
}
...
//TODO: Need to specify token properties.
interface IToken {
	access_token: string;
	refresh_token: string;
	expires_in: string | number;
...
// AuthenticatorContext related interfaces
...
export {
	...
	IOAuthConfig,
	IUtils,
	IAuthenticatorInitPayload,
	IAuthenticatorVerify
};