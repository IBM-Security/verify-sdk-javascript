...
describe("AuthenticatorContext - initiateAuthenticator()", () => {
    ...
    it("null token provided - should throw 'Token parameter is not a valid token'", () => {
        let data = {};
    ...
    it("invalid token (empty object) provided - should throw 'Token parameter is not a valid token'", () => {
        let data = {};
